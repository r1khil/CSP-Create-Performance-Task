...
#-----game configuration----
shape_of_turtle = ["circle", "triangle", "square", "star"]

color_of_turtle = ["green", "yellow", "blue", "black", "red"]
...
rikhil.shape(rand.choice(shape_of_turtle))

rikhil.color(rand.choice(color_of_turtle))
